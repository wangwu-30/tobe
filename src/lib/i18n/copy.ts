...
const COPY = {
  'en-US': {
    ...
    'goal.deliverableDescription':
      'Let AI take the first pass. You define the target; the next deliverable starts from a plan inside "{projectTitle}".',
    ...
    'plan.goal': 'Goal',
    'plan.nextDeliverableAction': 'Start Next Deliverable',
    ...
    'sidebar.newSiblingDeliverable': 'New Sibling Deliverable',
  ...
  'zh-CN': {
    ...
    'sidebar.newSiblingDeliverable': '新建同级交付物',
