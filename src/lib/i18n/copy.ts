...
const COPY = {
  'en-US': {
    ...
    'goal.createDeliverableFailed': 'Could not create this content.',
    ...
    'goal.deliverableDescription':
      'Let AI take the first pass. You define the target; the next item continues inside "{projectTitle}" from a plan instead of a blank file.',
    ...
    'goal.intentBothDescription':
      'Start from a written spec or brief, then create the companion web page in the same project.',
    ...
    'context.scopeDeliverable': 'Current Content',
    ...
    'context.noKnowledgeDescription':
      'Capture durable facts or references you want AI to reuse for this content.',
    ...
    'home.projectCardLatestNode': 'Latest active content',
    'home.projectCardNoRecentNode': 'No active content yet',
    'home.projectCardOpen': 'Open',
    'home.projectCardNewItem': 'New Item',
    ...
    'plan.goal': 'Goal',
    'plan.nextDeliverableAction': 'Continue to Next Item',
    'plan.nextDeliverableDescription':
      'Carry "{workflow}" into the next item in this project.',
    'plan.nextDeliverableTitle': 'Continue from this work',
    ...
    'plan.preparedLocalUpdate': 'Prepared a local content update.',
    ...
    'sidebar.newDeliverable': 'New Content',
    'sidebar.newProjectFolder': 'New Folder',
    'sidebar.newProjectFolderDefaultName': 'New Folder',
    'sidebar.newSiblingDeliverable': 'Continue to Next Item',
    'sidebar.newDeliverableHere': 'Continue from Here',
    'sidebar.newChildDeliverable': 'Create Child Item',
    ...
    'sidebar.continueCurrentDeliverable': 'Continue Current Item',
    'sidebar.renameDeliverable': 'Rename Content',
    'sidebar.renameDeliverableDescription':
      'Update the content name shown in the project tree and header.',
    'sidebar.renameDeliverableFailed': 'Could not rename this content.',
    'sidebar.renameDeliverablePlaceholder': 'Enter content name',
    'sidebar.renameDeliverableRequired': 'Enter a content name.',
    'sidebar.renameDeliverableSave': 'Save Content Name',
    'sidebar.moveDeliverable': 'Move Content',
    'sidebar.moveDeliverableDescription':
      'Choose where "{title}" should appear in the project tree.',
    'sidebar.moveDeliverableFailed': 'Could not move this content.',
    ...
    'sidebar.deleteDeliverableConfirm':
      'Delete this content? The current draft, conversations, and recovery points for it will be removed.',
    'sidebar.deleteProjectFolder': 'Delete Folder',
    'sidebar.deleteProjectFolderConfirm':
      'Delete this folder? Delete or move its child folders and content first.',
    ...
    'sidebar.noProjectDeliverablesYet': 'No content in this project yet.',
    'sidebar.noProjectTreeYet': 'No folders or content in this project yet.',
    'sidebar.projectDeliverableCountSingular': '1 node',
    'sidebar.projectDeliverableCountPlural': '{count} nodes',
    'sidebar.currentProjectLabel': 'Current Project',
    'sidebar.currentDeliverableBadge': 'Current',
    'sidebar.currentDeliverableMeta': 'Current content: {title}',
    'sidebar.searchProjectNodes': 'Find in Project',
    ...
    'sidebar.addLinkedProjectDescription':
      'Link another project into the current project so AI can reference its nodes on demand.',
    'sidebar.addLinkedProjectSelect': 'Project',
    'sidebar.addLinkedProjectPlaceholder': 'Choose a project',
    'sidebar.addLinkedProjectSave': 'Add Link',
    'sidebar.addLinkedProjectFailed': 'Could not link this project.',
    'sidebar.addLinkedProjectRequired': 'Choose a project to link.',
    'sidebar.noLinkableProjects': 'All other projects are already linked.',
    ...
    'sidebar.outlineEmpty':
      'AI will outline the current content here once the first structure is ready.',
    ...
    'workspace.deleteDeliverableFailed': 'Could not delete this content.',
    ...
    'workspace.renameDeliverableFailed': 'Could not rename this content.',
  ...
  'zh-CN': {
    ...
    'goal.createDeliverableFailed': '创建内容失败。',
    'goal.createProjectRetryUnknown':
      '这次创建结果还不明确。请重试一次以检查同一请求，而不是重新创建一个新项目。',
    'goal.createDeliverableRetryUnknown':
      '这次创建结果还不明确。请重试一次以检查同一请求，而不是重新创建一项新内容。',
    ...
    'context.workflowDraftFailed': '无法从当前内容生成 Workflow 草稿。',
    ...
    'sidebar.renameDeliverableSave': '保存内容名称',
    'sidebar.moveDeliverable': '移动内容',
    'sidebar.moveDeliverableDescription': '选择“{title}”在项目树里的新位置。',
    'sidebar.moveDeliverableFailed': '无法移动这项内容。',
    'sidebar.moveUp': '上移',
    'sidebar.moveDown': '下移',
    ...
    'sidebar.noProjectDeliverablesYet': '当前项目里还没有内容。',
    'sidebar.noProjectTreeYet': '当前项目里还没有文件夹或内容。',
    'sidebar.projectDeliverableCountSingular': '1 份内容',
    'sidebar.projectDeliverableCountPlural': '{count} 份内容',
    ...
    'sidebar.linkedProjects': '关联项目',
    'sidebar.linkedProjectBadge': '已关联',
    'sidebar.loadingLinkedProjects': '正在加载关联项目……',
    'sidebar.loadLinkedProjectsFailed': '无法加载关联项目。',
    'sidebar.noLinkedProjectsYet': '还没有关联项目。',
    'sidebar.linkedProjectReferenceOnly': '可作为按需引用的项目来源。',
    'sidebar.openLinkedProject': '打开',
    'sidebar.addLinkedProject': '添加关联项目',
    'sidebar.addLinkedProjectDescription':
      '把另一个项目接入当前项目，AI 就能按需引用其中的节点。',
    'sidebar.addLinkedProjectSelect': '项目',
    'sidebar.addLinkedProjectPlaceholder': '选择项目',
    'sidebar.addLinkedProjectSave': '添加关联',
    'sidebar.addLinkedProjectFailed': '无法关联这个项目。',
    'sidebar.addLinkedProjectRequired': '请选择要关联的项目。',
    'sidebar.noLinkableProjects': '其他项目都已关联。',
    ...
    'workspace.previewCouldNotStart': '这项内容暂时无法启动预览。',
    ...
    'workspace.deleteDeliverableFailed': '无法删除这项内容。',
